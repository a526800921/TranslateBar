...
This project is indexed by GitNexus as **TranslateBar** (714 symbols, 1757 relationships, 19 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
